...
const apiRequest = {
  ...
  getBookingData() {
    return fetch('http://overlookhotel.herokuapp.com/api/v1/bookings')
  ...
  getCustomerData() {
    return fetch('http://overlookhotel.herokuapp.com/api/v1/customers')
      .then(response => response.json())
  ...
  getRoomData() {
    return fetch('http://overlookhotel.herokuapp.com/api/v1/rooms')
      .then(response => response.json())
